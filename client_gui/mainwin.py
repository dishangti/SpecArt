...
class Ui_SpecArt_MainWindow(object):
    def setupUi(self, SpecArt_MainWindow):
        ...
        self.deal_tableView = QtWidgets.QTableView(self.centralwidget)
        self.deal_tableView.setGeometry(QtCore.QRect(480, 200, 181, 151))
        self.deal_tableView.setObjectName("deal_tableView")
        self.sell_tableView = QtWidgets.QTableView(self.centralwidget)
        self.sell_tableView.setGeometry(QtCore.QRect(300, 50, 181, 151))
        self.sell_tableView.setLineWidth(0)
        self.sell_tableView.setObjectName("sell_tableView")
        self.buy_tableView = QtWidgets.QTableView(self.centralwidget)
        self.buy_tableView.setGeometry(QtCore.QRect(480, 50, 181, 151))
        self.buy_tableView.setObjectName("buy_tableView")
