...
class Ui_SpecArt_MainWindow(object):
    def setupUi(self, SpecArt_MainWindow):
        ...
        self.deal_tableWidget.setGeometry(QtCore.QRect(380, 270, 271, 221))
        ...
        self.tans_tableWidget.horizontalHeader().setDefaultSectionSize(79)
        self.tans_tableWidget.verticalHeader().setVisible(False)
